...
public abstract class Conta implements ITaxas {
    ...
    public void transferir(Conta destino, double valor){
        ...
        try{
            this.saldo -= valor;
            destino.saldo += valor;
            System.out.println("Valor transferido da conta de " + getDono().getNome() + " para a conta de "
                + getDono().getNome() + ": " + valor);
            System.out.println("Saldo atual da conta de " + getDono().getNome() + ": " + getSaldo());
    ...
    public void extrato(int flag) {
        ...
        switch (flag) {
            ...
            case 1: {
                ...
                Collections.sort(operacoes); // Tentei clonar a arraylist operacoes utilizando ArrayList<Operacao>
                                             // cloneToSort = (ArrayList<Operacao>)operacoes.clone(); mas tava dando
                                             // warning de type safety
    ...
    // Método que sobrescreve a função toString da class Object e transforma tudo em
    // uma string - Atividade 05

    @Override
    public String toString() {
        String dadosConta = "Dados da conta: " + "\n" +
    ...
    // Método que sobrescreve a função equals da class Object e compara se dois
    // objetos são iguais - Atividade 05
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Conta) {
            ...
            if (this.getNumero() == outraConta.getNumero()) { // Por se tratar de um tipo primitivo (int) é possível
                                                              // utilizar o == em vez de this.getNumero().equals.etc
                return true;
            } else {
                return false;
            }
