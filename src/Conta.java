...
public abstract class Conta implements ITaxas{
     ...
     */
    public boolean saque(double valorSaque, String senha) throws ValorNegativoException, SemLimiteException{
     ...
     */
    public boolean depositar(double valorDeposito) throws ValorNegativoException{
     ...
     */
    public boolean tranferencia(Conta destinatario, double valorTransferencia, String senha) throws ValorNegativoException, SemLimiteException {
        boolean retorno;
