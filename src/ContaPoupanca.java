...
public class ContaPoupanca extends Conta{
    ...
    ContaPoupanca(Cliente tipoCliente, double saldoInicial, double limiteMovimentacao){
    ...
    protected double validarLimiteMovimentacao(double limiteSolicitado){
        ...
        if(limiteSolicitado > 0 && limiteSolicitado <= 1000) limiteliberado = limiteSolicitado;
    ...
    protected double solicitarNovoValor(){
        ...
        while (ERRO){
            ...
            ERRO = (valorLimiteMovimentacao < 0 || valorLimiteMovimentacao > 1000);
        }
